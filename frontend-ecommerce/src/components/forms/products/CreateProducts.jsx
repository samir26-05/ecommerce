    ...
    try {
      const response = await axios.post('http://localhost:3000/product/create', formData, {
        headers: {
          ...
          'accessToken': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MywidXNlcm5hbWUiOiJzYW9yb3pjbzI2MDUiLCJpYXQiOjE2OTM1MDM5ODksImV4cCI6MTY5MzUwNzU4OX0.c6XdjZawdn4_i5O_bevEtpOQzTwnx-bFYeLxJ--Zf6o'
        }
      })
