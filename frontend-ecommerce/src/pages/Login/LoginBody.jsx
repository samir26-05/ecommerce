                ...
                <div className="card-3d-wrapper">
                  <div className="card-front">
                    <div className="center-wrap">
                      <div className="section text-center">
                        ...
                        <button className="btn mt-4" onClick={loginn}>Login</button>
                  ...
                  <Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validationSchema}>
                      <Form>
                        ...
                        <div className="form-group">
                          <Field
                            placeholder="Ingrese su Usuario" name="user"  className="form-style"
                          />
                        ...
                        <div className="form-group mt-2">
                          ...
                          <ErrorMessage name='nombre' component='div' className="hola"/>
                        ...
                        <button type="submit" onClick={toggleLogin} className="btn mt-4">Register</button>
                        </Form>
                  </Formik>
                      </div>
                    </div>
