...
export default function UpdatePass() {
  return (
    ...
    >
      <div>
        <TextField id="outlined-multiline-flexible" label="Tu contraseña" multiline maxRows={12} />
        <TextField id="outlined-multiline-flexible" label="Nueva contraseña" multiline maxRows={12} />
        <TextField id="outlined-multiline-flexible" label="Confirmar nueva contraseña" multiline maxRows={12} />
      </div>
      <div>
