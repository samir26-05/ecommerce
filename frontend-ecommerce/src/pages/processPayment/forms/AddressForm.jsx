  ...
  return (
    <React.Fragment>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <TextField required id="address1" name="address1" label="Direccion linea 1" fullWidth autoComplete="shipping address-line1" variant="standard" />
        </Grid>
        <Grid item xs={12}>
          <TextField id="address2" name="address2" label="Direccion linea 2" fullWidth autoComplete="shipping address-line2" variant="standard" />
        </Grid>
        <Grid item xs={12} sm={6}>
          <TextField required id="city" name="city" label="Ciudad" fullWidth autoComplete="shipping address-level2" variant="standard" />
        </Grid>
        <Grid item xs={12} sm={6}>
          <TextField id="state" name="state" label="Estado/Provincia/Region" fullWidth variant="standard" />
        </Grid>
        <Grid item xs={12} sm={6}>
